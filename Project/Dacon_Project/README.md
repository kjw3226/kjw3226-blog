# 2022 Dacon House Price Prediction Contest (집값 예측 경진대회)

![](img/dacon-correction.png)
...
'housing'(기본 데이터 셋)을 이용해 시각화와 모델링을 구성하고

 최종 예측 집값을 출력하는 대회

#### 2.도전 목표

'housing'(기본 데이터 셋)을 이용해 

데이터 시각화를 구현하고

Pycaret과 Blend Model을 사용해서 가장 작합한 모델을 적용하고 
...
[House Price Prediction Using Pycret and Bland Model](Project/Dacon_Project/source/House Price Prediction Using Pycret and Bland Model Code.md)

## House Price Prediction Using Pycret and Bland Model
